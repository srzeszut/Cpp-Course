...
public:
    TwoDimensionMatrix();
    TwoDimensionMatrix(const TwoDimensionMatrix& other_matrix);
    explicit TwoDimensionMatrix(const MatrixElement matrix[size_][size_]);
    static constexpr size_t size(){
        return size_;
    };
    MatrixElement get(size_t x,size_t y) const;
    TwoDimensionMatrix& operator=(const TwoDimensionMatrix& other_matrix);
    friend std::ostream& operator <<(std::ostream& os,const TwoDimensionMatrix& matrix);
    ...
    TwoDimensionMatrix operator&&(const TwoDimensionMatrix& other_matrix) const;
